...
export const socials = [
  { href: "https://github.com", icon: <SiGithub />, name: "GitHub" },
  { href: "https://x.com", icon: <SiX />, name: "X (Twitter)" },
]
          ...
          <h5 className="mb-8">
            <a href="/" className="flex items-center gap-3 text-white group">
              <img
                ...
                alt="Logo"
              />
              <span className="text-lg font-medium text-white transition-all duration-300 group-hover:text-purple-30">Web Soroban</span>
            </a>
          </h5>
          ...
          <div className="flex gap-6">
            {socials.map((item, index) => (
              <a
                ...
                title={item.name}
              >
                <div className="text-white group-hover:text-purple-300 transition-colors duration-300 w-5 h-5">
                  {item.icon}
                </div>
